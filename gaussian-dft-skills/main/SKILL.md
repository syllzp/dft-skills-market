...
| multireference-reference | Recommend CASSCF/CASCI methods and active spaces | `../skills/multireference-reference/SKILL.md` |
...
- **Recommend multireference methods** (keywords: CASSCF, CASCI, multireference, active space, state-average, SA-CASSCF, strong correlation, CAS) → `../skills/multireference-reference/SKILL.md`
